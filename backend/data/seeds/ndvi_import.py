"""Import NDVI CSV directly into Supabase via asyncpg (batched)"""
...
async def main():
    ...
    await conn.execute("DELETE FROM indices_satelitales")
    ...
    with open(CSV_PATH, newline="", encoding="utf-8") as f:
        ...
        for i, row in enumerate(reader):
            ...
            if len(batch) >= BATCH_SIZE:
                ...
                batch.clear()
                print(f"  Insertados {kept} de {total}...", end="\r")
    ...
    await conn.close()
    print(f"\nListo. {kept} filas insertadas de {total} leidas.")
