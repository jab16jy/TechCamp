"""Import PARTE 6 + 7 — Sincelejo + Monteria NDVI into local Docker PostGIS"""
import asyncio
import csv
import math
...
FILES = [
    ("Sincelejo", Path(r"D:\sentinel 2\nvdi\nvdi_parte6\nvdi_parte6final.csv"), 10, 0.1),
    ("Monteria", Path(r"D:\sentinel 2\nvdi\nvdi_parte7\nvdi_parte7final.csv"), 10, 0.1),
]
