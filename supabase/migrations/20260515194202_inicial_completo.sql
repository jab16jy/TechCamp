...
CREATE TABLE IF NOT EXISTS "public"."analisis" (
    ...
    "tipo" character varying(20) DEFAULT 'simple'::character varying NOT NULL,
    "datos_formulario" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "resultado_completo" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "lat" double precision,
    "lng" double precision,
    "cultivo_recomendado" character varying(100),
    "score" integer,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "analisis_tipo_check" CHECK ((("tipo")::"text" = ANY ((ARRAY['simple'::character varying, 'advanced'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."indices_satelitales" (
    ...
    "calidad_suelo" character varying(50),
    "cobertura_nube" integer,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);


ALTER TABLE "public"."indices_satelitales" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."indices_satelitales_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."indices_satelitales_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."indices_satelitales_id_seq" OWNED BY "public"."indices_satelitales"."id";
...
CREATE TABLE IF NOT EXISTS "public"."mensajes" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "mensajes_rol_check" CHECK ((("rol")::"text" = ANY ((ARRAY['usuario'::character varying, 'ia'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."sensores" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "nodo_id" character varying(50) NOT NULL,
    "nombre" character varying(100) NOT NULL,
    "lat" double precision NOT NULL,
    "lng" double precision NOT NULL,
    "estado" character varying(20) DEFAULT 'ok'::character varying NOT NULL,
    "ubicacion" "public"."geometry"(Point,4326),
    CONSTRAINT "sensores_estado_check" CHECK ((("estado")::"text" = ANY ((ARRAY['ok'::character varying, 'warn'::character varying, 'critical'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."usuarios" (
    ...
    "nombre" character varying(200) NOT NULL,
    "rol" character varying(50) DEFAULT 'investigador'::character varying NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "usuarios_rol_check" CHECK ((("rol")::"text" = ANY ((ARRAY['investigador'::character varying, 'productor'::character varying])::"text"[])))
);
...
ALTER TABLE ONLY "public"."indices_satelitales" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."indices_satelitales_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."indices_satelitales"
    ADD CONSTRAINT "indices_satelitales_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."sensores"
    ADD CONSTRAINT "sensores_nodo_id_key" UNIQUE ("nodo_id");
...
CREATE INDEX "idx_analisis_created_at" ON "public"."analisis" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_analisis_municipio_id" ON "public"."analisis" USING "btree" ("municipio_id");



CREATE INDEX "idx_analisis_usuario_id" ON "public"."analisis" USING "btree" ("usuario_id");



CREATE INDEX "idx_conversaciones_usuario_id" ON "public"."conversaciones" USING "btree" ("usuario_id");



CREATE INDEX "idx_indices_satelitales_coords" ON "public"."indices_satelitales" USING "btree" ("lat", "lng");



CREATE INDEX "idx_indices_satelitales_ubicacion" ON "public"."indices_satelitales" USING "gist" ("ubicacion");



CREATE INDEX "idx_lecturas_created_at" ON "public"."lecturas_sensores" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_lecturas_sensor_id" ON "public"."lecturas_sensores" USING "btree" ("sensor_id");



CREATE INDEX "idx_mensajes_conversacion_id" ON "public"."mensajes" USING "btree" ("conversacion_id");
...
CREATE INDEX "idx_municipios_geometry" ON "public"."municipios" USING "gist" ("geometry");



CREATE INDEX "idx_parcelas_poligono" ON "public"."parcelas" USING "gist" ("poligono");
...
CREATE INDEX "idx_sensores_nodo_id" ON "public"."sensores" USING "btree" ("nodo_id");



CREATE INDEX "idx_sensores_ubicacion" ON "public"."sensores" USING "gist" ("ubicacion");



ALTER TABLE ONLY "public"."analisis"
    ADD CONSTRAINT "analisis_municipio_id_fkey" FOREIGN KEY ("municipio_id") REFERENCES "public"."municipios"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."analisis"
    ADD CONSTRAINT "analisis_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "public"."usuarios"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."conversaciones"
    ADD CONSTRAINT "conversaciones_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "public"."usuarios"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."lecturas_sensores"
    ADD CONSTRAINT "lecturas_sensores_sensor_id_fkey" FOREIGN KEY ("sensor_id") REFERENCES "public"."sensores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."parcelas"
    ADD CONSTRAINT "parcelas_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "public"."usuarios"("id") ON DELETE CASCADE;
...
CREATE POLICY "analisis_select_own" ON "public"."analisis" FOR SELECT USING (("usuario_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "conversaciones_all_own" ON "public"."conversaciones" USING (("usuario_id" = ( SELECT "auth"."uid"() AS "uid")));



ALTER TABLE "public"."indices_satelitales" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "indices_satelitales_select_public" ON "public"."indices_satelitales" FOR SELECT USING (true);
...
CREATE POLICY "lecturas_sensores_select_public" ON "public"."lecturas_sensores" FOR SELECT USING (true);
...
CREATE POLICY "mensajes_via_conversacion" ON "public"."mensajes" USING (("conversacion_id" IN ( SELECT "conversaciones"."id"
   FROM "public"."conversaciones"
  WHERE ("conversaciones"."usuario_id" = ( SELECT "auth"."uid"() AS "uid")))));
...
CREATE POLICY "municipios_select_public" ON "public"."municipios" FOR SELECT USING (true);
...
CREATE POLICY "parcelas_all_own" ON "public"."parcelas" USING (("usuario_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "sensores_select_public" ON "public"."sensores" FOR SELECT USING (true);
...
CREATE POLICY "usuarios_select_own" ON "public"."usuarios" FOR SELECT USING (("id" = ( SELECT "auth"."uid"() AS "uid")));
...
GRANT ALL ON TABLE "public"."analisis" TO "anon";
GRANT ALL ON TABLE "public"."analisis" TO "authenticated";
GRANT ALL ON TABLE "public"."analisis" TO "service_role";
...
GRANT ALL ON TABLE "public"."indices_satelitales" TO "anon";
GRANT ALL ON TABLE "public"."indices_satelitales" TO "authenticated";
GRANT ALL ON TABLE "public"."indices_satelitales" TO "service_role";



GRANT ALL ON SEQUENCE "public"."indices_satelitales_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."indices_satelitales_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."indices_satelitales_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."lecturas_sensores" TO "anon";
GRANT ALL ON TABLE "public"."lecturas_sensores" TO "authenticated";
GRANT ALL ON TABLE "public"."lecturas_sensores" TO "service_role";
...
GRANT ALL ON TABLE "public"."sensores" TO "anon";
GRANT ALL ON TABLE "public"."sensores" TO "authenticated";
GRANT ALL ON TABLE "public"."sensores" TO "service_role";
...
alter table "public"."analisis" drop constraint "analisis_tipo_check";

alter table "public"."mensajes" drop constraint "mensajes_rol_check";

alter table "public"."sensores" drop constraint "sensores_estado_check";

alter table "public"."usuarios" drop constraint "usuarios_rol_check";

alter table "public"."analisis" add constraint "analisis_tipo_check" CHECK (((tipo)::text = ANY ((ARRAY['simple'::character varying, 'advanced'::character varying])::text[]))) not valid;

alter table "public"."analisis" validate constraint "analisis_tipo_check";

alter table "public"."mensajes" add constraint "mensajes_rol_check" CHECK (((rol)::text = ANY ((ARRAY['usuario'::character varying, 'ia'::character varying])::text[]))) not valid;

alter table "public"."mensajes" validate constraint "mensajes_rol_check";

alter table "public"."sensores" add constraint "sensores_estado_check" CHECK (((estado)::text = ANY ((ARRAY['ok'::character varying, 'warn'::character varying, 'critical'::character varying])::text[]))) not valid;

alter table "public"."sensores" validate constraint "sensores_estado_check";

alter table "public"."usuarios" add constraint "usuarios_rol_check" CHECK (((rol)::text = ANY ((ARRAY['investigador'::character varying, 'productor'::character varying])::text[]))) not valid;
